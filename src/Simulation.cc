...
void
ReceivePacketWithRss (std::string context, Ptr<const Packet> packet, uint16_t channelFreqMhz, WifiTxVector txVector, MpduInfo aMpdu, SignalNoiseDbm signalNoise, uint16_t staId)
{
  WifiMacHeader hdr;
...
int main (int argc, char *argv[])
{
 ...
 // double rss = -80;  // -dBm
  ...
  Simulator::ScheduleWithContext (wifinetdeviceA->GetNode ()->GetId (),Seconds (1.0), &GenerateTraffic, wifinetdeviceA, packetSize, packets, interPacketInterval);
